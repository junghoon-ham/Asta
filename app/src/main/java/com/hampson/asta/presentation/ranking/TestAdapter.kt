...
import com.hampson.asta.databinding.ItemRankingAuctionBinding
...
class TestAdapter(val dataList: ArrayList<Product> = ArrayList()) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder =
        MyViewHolder(
            ItemRankingAuctionBinding.inflate(
    ...
    inner class MyViewHolder(val binding: ItemRankingAuctionBinding) :
