...
import com.hampson.asta.databinding.FragmentHistoryAuctionViewBinding
...
@AndroidEntryPoint
class ProceedingAuctionFragment : BaseFragment() {
    private var _binding: FragmentHistoryAuctionViewBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHistoryAuctionViewBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setupRecyclerView() {
        ...
        binding.recyclerView.apply {
            adapter = TestAdapter(dataList).apply {
                context = this@ProceedingAuctionFragment.context
            }
